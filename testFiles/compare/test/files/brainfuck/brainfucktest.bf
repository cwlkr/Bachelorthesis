...
##
% 7(0) *1 (bcode) 0 M m     (where 16b integer Mm = maximum loop depth of bcode)
...
>[-
# RMUL
% 0 0 (bcode) P p 0 *0 0 (Q q bcode) 0 0 0 1 (stack) 1 0 0 0 (jmplist)
>>[-<<<+>>>]>[-<<<+>>>]+++++++<
% 0 0 (bcode) P p Q q 0 *0 7 (bcode) 0 0 0 1 (stack) 1 0 0 0 (jmplist)
]<]
>[-
# LMUL
% 0 0 (bcode) P p 0 *0 0 (Q q bcode) 0 0 0 1 (stack) 1 0 0 0 (jmplist)
...
# if p==2 then s=2
# if p in 3::127 then s=3
# if p==128 then s=4
# if p==129 then s=5
# if p in 130::254 then s=6
# if p==255 then s=7
>+<<<<----->-[<+>>>>+<<<-[
 >++++++++++[-<<++++++++++++>>]>>--<<<<+++
 [->->+<[>-]>[>]<[->>[-]+<<]<<]>>+>>[-<<->>]+++<<[
...
# Depending on the operation the code above may have left a value s
...
<+>-[-[-[-[-[-[-[-[-[-[--[[-]<->]
<[-
# RMUL(x y): B0yF6210041x
% ::: 0 *0 0 x 13 y (bcode) 0 1 ::: 1 0 0 0 (jmplist)
++++++++++++++++[->+++++++++++<]>.>>>.[-]<--[-<<++++++>>]
<<++++.++[--------<+>]<++.>.<[->++<]>-.[-]>.[-]
]>]
<[-
# LMUL(x y): B0yyF6210041xx
% ::: 0 *0 0 x 11 y (bcode) 0 1 ::: 1 0 0 0 (jmplist)
++++++++++++++++[->+++++++++++<]>.>>>.[-]<[-<<++++++>>]
<<++++.++[--------<+>]<++.>.<[->++<]>-.-[->>++++<<]>[->-<]>.[-]<
0 0 *0 0 0 (bcode)
]>]
...
# 41     if x==1
# 01E9   if x==2
# 83C1y  else  (where y=x if x in 3::127 else 127)
# if x gt 127 then prepend RIGHT(sub(x 127)) to (code) for reprocessing
% ::: 0 *0 0 x (bcode) 0 1 ::: 1 0 0 0 (jmplist)
>+>-[-[
<+++++++++[-<+++++++++++++>]<+.>++++++[-<++++++++++>]<++.[-]
++++++++[-<++++++++++++++++>]<---
...
# 49     if x==1
# 29E9   if x==2
# 83E9y  else  (where y=x if x in 3::127 else 127)
# if x gt 127 then prepend LEFT(sub(x 127)) to (code) for reprocessing
% ::: 0 *0 0 x (bcode) 0 1 ::: 1 0 0 0 (jmplist)
>+>-[-[
<+++++++++[-<+++++++++++++>]<+.>++++++++++[-<++++++++++>]<++.[-]
++++++++[-<++++++++++++++++>]<---
